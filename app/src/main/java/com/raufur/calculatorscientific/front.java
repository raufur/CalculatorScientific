package com.raufur.calculatorscientific;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			case 0:
				Class myclass;
				try {
					myclass = Class.forName("com.raufur.calculatorscientific.simple");
			...
			case 1:
				Class myclass2;
				try {
					myclass2 = Class.forName("com.raufur.calculatorscientific.lands");
			...
			case 2:
				Class myclass3;
				try {
					myclass = Class.forName("com.raufur.calculatorscientific.complex");
